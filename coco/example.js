...
/***/ (function(module, exports, __webpack_require__) {
	...
	var overlap = __webpack_require__(8);
	var union = __webpack_require__(25);
	read('trajectories/trident-01.json', showTrajectory);

	read('subjects.json', function(geoJson){
	    geoJson.features.forEach(function(feature) {
	        swapLatLon(feature.geometry.coordinates);
	    });
	    var combined = union.apply(null, geoJson.features);
	    geoJson.features = allOverlapings(geoJson.features);
	    geoJson.features = geoJson.features.concat(combined);
	    geoJson.features.forEach(function(feature) {
	        feature.properties.api = 'nic';
	        feature.properties.depth = true;
	        feature.properties.simplify = true;
	        feature.properties.width = 2;
	    });
	    Events.post(Events.CREATE_GEO_JSON_OBJECT, geoJson);
	});

	function allOverlapings(features) {
	    var all = [];
	    while (features.length > 0) {
	        var one = features.pop();
	        features.forEach(function(other) {
	           all = all.concat(overlap(one, other).features);
	        });
	    }
	    return all;
	}
	...
	function showTrajectory(json){
	    Events.post(Events.CREATE_GEO_JSON_OBJECT, {
	        type: "Feature",
	        geometry: {
	            type: "LineString",
	            coordinates: json.map(function(r){
	                return [r[1], r[2], r[3]];
	            }),
	            properties: {
	                color: 'ff0000ff'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rbush = _interopDefault(__webpack_require__(9));
	var lineSegment = _interopDefault(__webpack_require__(10));
	var pointOnLine = _interopDefault(__webpack_require__(14));
	var booleanPointOnLine = _interopDefault(__webpack_require__(23));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var bearing = _interopDefault(__webpack_require__(15));
	var distance = _interopDefault(__webpack_require__(16));
	var destination = _interopDefault(__webpack_require__(17));
	var lineIntersects = _interopDefault(__webpack_require__(18));
	var meta = __webpack_require__(13);
	var helpers = __webpack_require__(11);
	var invariant = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rbush = __webpack_require__(20);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var quickselect = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getCoords = __webpack_require__(24).getCoords;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jsts = __webpack_require__(26);
