...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  function GeneratorAsBackground({ type, id, hash = null }) {
    ...
    (0, import_react.useEffect)(() => {
      if (!code)
        return;
      let newHtml = type === "artblocks" ? prepareArtBlocks(code, hash || randomAbHash()) : prepareFxHash(code, hash || randomFxHash());
      setHtml(newHtml);
    }, [code, hash, type]);
  ...
  function GeneratorPage() {
    ...
    return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement(Navigation, null), /* @__PURE__ */ import_react3.default.createElement(
      "button",
      {
        style: {
          position: "fixed",
      ...
      /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement(
        ...
        /* @__PURE__ */ import_react3.default.createElement("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        /* @__PURE__ */ import_react3.default.createElement("polyline", { points: "6 21 21 6 18 3 3 18 6 21" }),
        /* @__PURE__ */ import_react3.default.createElement("line", { x1: "15", y1: "6", x2: "18", y2: "9" }),
        /* @__PURE__ */ import_react3.default.createElement("path", { d: "M9 3a2 2 0 0 0 2 2a2 2 0 0 0 -2 2a2 2 0 0 0 -2 -2a2 2 0 0 0 2 -2" }),
        /* @__PURE__ */ import_react3.default.createElement("path", { d: "M19 13a2 2 0 0 0 2 2a2 2 0 0 0 -2 2a2 2 0 0 0 -2 -2a2 2 0 0 0 2 -2" })
      ))
  ...
  function useMediaQuery(query) {
    const queryRef = (0, import_react4.useRef)(window.matchMedia(query));
    const [matches, setMatches] = (0, import_react4.useState)(queryRef.current.matches);
