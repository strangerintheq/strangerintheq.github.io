...
function newPainting(e) {
    ...
    console.log('execute in console to get this image: creature('+prng._seed+");")
    init();
    reset();
...
function eraseFrame(){
    ...
    for (let j=0; j < 5000; j ++){
        ...
        let p2 = {x: minus(), y: plus()};
        let p3 = {x: plus(), y: plus()};
        line(p0, p2)
        line(p1, p3);
        line(p0, p1);
        line(p2, p3);
